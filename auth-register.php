...
const ERROR_PASSWORD_TOO_SHORT = 'Le mot de passe doit faire
 au moins 6 caractères';
const ERROR_PASSWORD_MISMATCH = 'Le mot de passe de
confirmation est différent';
...
<head>
    ...
    <link rel="stylesheet"
          href="/public/css/auth-register.css">
            ...
            <form action="/auth-register.php" , method="POST">
                ...
                <div class="form-control">
                    ...
                    <?php if ($errors['lastname']) : ?>
                        <p class="text-danger"><?= $errors['lastname']
                            ?></p>
                    <?php endif; ?>
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    <label for="confirmpassword">Confirmation mot de
                        passe</label>
